...
#endif
#if defined(MOZJS_MAJOR_VERSION)
bool js_PluginShareJS_PluginShare_setFileProviderAuthorities(JSContext *cx, uint32_t argc, JS::Value *vp)
{
    JS::CallArgs args = JS::CallArgsFromVp(argc, vp);
    bool ok = true;
    if (argc == 1) {
        std::string arg0;
        ok &= jsval_to_std_string(cx, args.get(0), &arg0);
        JSB_PRECONDITION2(ok, cx, false, "js_PluginShareJS_PluginShare_setFileProviderAuthorities : Error processing arguments");
        sdkbox::PluginShare::setFileProviderAuthorities(arg0);
        args.rval().setUndefined();
        return true;
    }
    JS_ReportErrorUTF8(cx, "js_PluginShareJS_PluginShare_setFileProviderAuthorities : wrong number of arguments");
    return false;
}
#elif defined(JS_VERSION)
JSBool js_PluginShareJS_PluginShare_setFileProviderAuthorities(JSContext *cx, uint32_t argc, jsval *vp)
{
    jsval *argv = JS_ARGV(cx, vp);
    JSBool ok = JS_TRUE;
    if (argc == 1) {
...
#endif
#if defined(MOZJS_MAJOR_VERSION)
bool js_PluginShareJS_PluginShare_logoutTwitter(JSContext *cx, uint32_t argc, JS::Value *vp)
{
    JS::CallArgs args = JS::CallArgsFromVp(argc, vp);
    if (argc == 0) {
    ...
    JS_ReportErrorUTF8(cx, "js_PluginShareJS_PluginShare_logoutTwitter : wrong number of arguments");
    return false;
}
#elif defined(JS_VERSION)
JSBool js_PluginShareJS_PluginShare_logoutTwitter(JSContext *cx, uint32_t argc, jsval *vp)
{
    if (argc == 0) {
        sdkbox::PluginShare::logoutTwitter();
        JS_SET_RVAL(cx, vp, JSVAL_VOID);
...
#endif
#if defined(MOZJS_MAJOR_VERSION)
bool js_PluginShareJS_PluginShare_setGDPR(JSContext *cx, uint32_t argc, JS::Value *vp)
{
    JS::CallArgs args = JS::CallArgsFromVp(argc, vp);
    bool ok = true;
    if (argc == 1) {
        ...
        JSB_PRECONDITION2(ok, cx, false, "js_PluginShareJS_PluginShare_setGDPR : Error processing arguments");
        sdkbox::PluginShare::setGDPR(arg0);
        args.rval().setUndefined();
        return true;
    }
    JS_ReportErrorUTF8(cx, "js_PluginShareJS_PluginShare_setGDPR : wrong number of arguments");
    return false;
}
#elif defined(JS_VERSION)
JSBool js_PluginShareJS_PluginShare_setGDPR(JSContext *cx, uint32_t argc, jsval *vp)
{
    jsval *argv = JS_ARGV(cx, vp);
    JSBool ok = JS_TRUE;
    if (argc == 1) {
...
void js_register_PluginShareJS_PluginShare(JSContext *cx, JS::HandleObject global) {
    ...
    static JSFunctionSpec st_funcs[] = {
        ...
        JS_FN("setFileProviderAuthorities", js_PluginShareJS_PluginShare_setFileProviderAuthorities, 1, JSPROP_PERMANENT | JSPROP_ENUMERATE),
        JS_FN("init", js_PluginShareJS_PluginShare_init, 0, JSPROP_PERMANENT | JSPROP_ENUMERATE),
        JS_FN("logoutTwitter", js_PluginShareJS_PluginShare_logoutTwitter, 0, JSPROP_PERMANENT | JSPROP_ENUMERATE),
        JS_FN("setGDPR", js_PluginShareJS_PluginShare_setGDPR, 1, JSPROP_PERMANENT | JSPROP_ENUMERATE),
        JS_FS_END
    };
