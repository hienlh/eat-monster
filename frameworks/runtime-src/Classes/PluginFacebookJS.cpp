...
#endif
#if defined(MOZJS_MAJOR_VERSION)
bool js_PluginFacebookJS_PluginFacebook_setLoginBehavior(JSContext *cx, uint32_t argc, JS::Value *vp)
{
    JS::CallArgs args = JS::CallArgsFromVp(argc, vp);
    bool ok = true;
    if (argc == 1) {
        ...
        JSB_PRECONDITION2(ok, cx, false, "js_PluginFacebookJS_PluginFacebook_setLoginBehavior : Error processing arguments");
        sdkbox::PluginFacebook::setLoginBehavior(arg0);
        args.rval().setUndefined();
        return true;
    }
    JS_ReportErrorUTF8(cx, "js_PluginFacebookJS_PluginFacebook_setLoginBehavior : wrong number of arguments");
    return false;
}
#elif defined(JS_VERSION)
JSBool js_PluginFacebookJS_PluginFacebook_setLoginBehavior(JSContext *cx, uint32_t argc, jsval *vp)
{
...
#endif
#if defined(MOZJS_MAJOR_VERSION)
bool js_PluginFacebookJS_PluginFacebook_gameRequest(JSContext *cx, uint32_t argc, JS::Value *vp)
{
    JS::CallArgs args = JS::CallArgsFromVp(argc, vp);
    bool ok = true;
    if (argc == 2) {
        ...
        ok &= jsval_to_std_string(cx, args.get(1), &arg1);
        JSB_PRECONDITION2(ok, cx, false, "js_PluginFacebookJS_PluginFacebook_gameRequest : Error processing arguments");
        sdkbox::PluginFacebook::gameRequest(arg0, arg1);
        args.rval().setUndefined();
        return true;
    }
    JS_ReportErrorUTF8(cx, "js_PluginFacebookJS_PluginFacebook_gameRequest : wrong number of arguments");
    return false;
}
#elif defined(JS_VERSION)
JSBool js_PluginFacebookJS_PluginFacebook_gameRequest(JSContext *cx, uint32_t argc, jsval *vp)
{
    jsval *argv = JS_ARGV(cx, vp);
    JSBool ok = JS_TRUE;
    if (argc == 2) {
...
#endif
#if defined(MOZJS_MAJOR_VERSION)
bool js_PluginFacebookJS_PluginFacebook_setGDPR(JSContext *cx, uint32_t argc, JS::Value *vp)
{
    JS::CallArgs args = JS::CallArgsFromVp(argc, vp);
    bool ok = true;
    if (argc == 1) {
        ...
        JSB_PRECONDITION2(ok, cx, false, "js_PluginFacebookJS_PluginFacebook_setGDPR : Error processing arguments");
        sdkbox::PluginFacebook::setGDPR(arg0);
        args.rval().setUndefined();
        return true;
    }
    JS_ReportErrorUTF8(cx, "js_PluginFacebookJS_PluginFacebook_setGDPR : wrong number of arguments");
    return false;
}
#elif defined(JS_VERSION)
JSBool js_PluginFacebookJS_PluginFacebook_setGDPR(JSContext *cx, uint32_t argc, jsval *vp)
{
    jsval *argv = JS_ARGV(cx, vp);
    JSBool ok = JS_TRUE;
    if (argc == 1) {
...
void js_register_PluginFacebookJS_PluginFacebook(JSContext *cx, JS::HandleObject global) {
...
#else
    static JSClass PluginFacebook_class = {
        "PluginFacebook",
        JSCLASS_HAS_PRIVATE,
        nullptr
    };
    jsb_sdkbox_PluginFacebook_class = &PluginFacebook_class;
#endif
    ...
    static JSFunctionSpec st_funcs[] = {
        ...
        JS_FN("setLoginBehavior", js_PluginFacebookJS_PluginFacebook_setLoginBehavior, 1, JSPROP_PERMANENT | JSPROP_ENUMERATE),
        JS_FN("requestGift", js_PluginFacebookJS_PluginFacebook_requestGift, 3, JSPROP_PERMANENT | JSPROP_ENUMERATE),
        JS_FN("gameRequest", js_PluginFacebookJS_PluginFacebook_gameRequest, 2, JSPROP_PERMANENT | JSPROP_ENUMERATE),
        ...
        JS_FN("setGDPR", js_PluginFacebookJS_PluginFacebook_setGDPR, 1, JSPROP_PERMANENT | JSPROP_ENUMERATE),
